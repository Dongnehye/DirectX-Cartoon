...
DXApp::DXApp(HINSTANCE hinstance)
{
	...
	clientWidth = 1280;
	clientHeight = 800;
	appTitle = L"Engine24 - Engine Update2";
...
void DXApp::InitMeshInfo()
{
	...
	ShaderUtil::Texture WallTexture;
	WallTexture.fileName = L"Resources//Textures//Wall.jpg";

	ShaderUtil::Texture WallNormalMap;
	WallNormalMap.fileName = L"Resources//Textures//NormalMap.png";
	...
	//// 픽셀 쉐이더에서 사용하는 텍스처 추가.
	//sphereMesh.pixelShader.pTextures.push_back(WallTexture);
	//
	//sphereMesh.pixelShader.pTextures.push_back(WallNormalMap);
	//// 트랜스폼 설정.
	...
	tppMesh.vertexShader = ShaderUtil::VertexShader(L"Shaders//ToonVS.fx", "main", "vs_5_0");
	tppMesh.pixelShader = ShaderUtil::PixelShader(L"Shaders//ToonPS.fx", "main", "ps_5_0");
	// 픽셀 쉐이더 쪽에서 사용하는 텍스처 추가.
	tppMesh.pixelShader.pTextures.push_back(tppDiffuseMap);
	// 위치 설정.
	tppMesh.position = XMFLOAT3(0.0f, -120.0f, 0.0f);
